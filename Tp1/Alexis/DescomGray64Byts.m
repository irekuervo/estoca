...
%%% Creamos las matrices que van a contener los datos de los bloques en los
%%% que se va a dividir la imagen. Como se va a dividir la imagen en bloques
...
%%% múltiplos de 8 o no. En función a estos flags establezco el size de la
%%% matriz Orden que contiene los bloques.

%%% Mini-Glosario para esta seccion%%%
% -"flag_size_inade_col" es 1 si hay que completar las columnas de los 
...
% -"Tam_img_ampl" contiene los valores de size (uso el ingles porque no puedo
...
%%% En función de los flags que tengo levantados, me creo las matrices que
%%% van a contener los datos en forma de vectores de 64x1 y además me creo
